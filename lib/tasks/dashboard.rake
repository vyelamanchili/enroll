namespace :dashboard do
  ...
  task :seed => :environment do 
    event_topics = ["IVL Enrollment - Submitted At", 'auto_renewal', 'added_family_member', 'shop_coverage_terminated', 'SHOP Enrollment - Submitted At']
    event_count = 535
    min_start_at = Time.new(2015, 11, 1, 0, 0, 0).to_i
    max_end_at = Time.new(2016, 4, 31, 23, 59, 59).to_i
