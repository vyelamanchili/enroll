...
RSpec.describe Employers::BrokerAgencyController do
  ...
  describe ".create" do
    ...
    context 'with out search string' do
      ...
      it "should be a success" do
        expect(flash[:notice]).to eq("Your broker has been notified of your selection and should contact you shortly. You can always call or email them directly, but if this is not the broker you want to use, select 'Change Broker'.")
  ...
  describe ".create for invalid plan year" do
    before (:each) do
          ...
          invalid_plan.save!(validate: false)
